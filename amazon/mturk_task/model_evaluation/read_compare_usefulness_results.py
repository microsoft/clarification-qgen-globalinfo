...
model_pair_choices = ['gan-bart_misinfo_pplm', 'bart-bart_misinfo_pplm', 'bart_misinfo-bart_misinfo_pplm']

def main(args):
    missing_annotations = 0
    model_pair = {}
    model_comparison = defaultdict(list)
    model_comparision_aggr = {'gan-bart_misinfo_pplm': [0, 0], 'bart-bart_misinfo_pplm': [0, 0], 'bart_misinfo-bart_misinfo_pplm': [0, 0]}
    rejected = 0
